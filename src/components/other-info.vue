        ...
        <div class="card">
            ...
            <div class="content">
                <div class="details">
                    ...
                    <div class="data">
                        <h3>账号<br /><sub>{{item.account}}</sub></h3>
                        <h3>年龄<br /><sub>{{item.age}}</sub></h3>
                        <h3>性别<br /><sub>{{sexDic[item.sex]}}</sub></h3>
                    </div>
                    <div class="actionBtn">
                        <button @click="Follow(item.account,item.isattention)" v-if="!item.isattention">关注Ta</button>
                        <button @click="Follow(item.account,item.isattention)" v-else>已关注</button>
                        <button>添加好友</button>
                    </div>
                </div>
            </div>

import {
  ShaderBase
} from "./chunk-DOFADT6H.js";
import {
  VANTA
} from "./chunk-ULQC4RNX.js";

// node_modules/vanta/src/vanta.halo.js
var win = typeof window == "object";
var THREE = win && window.THREE;
var Halo = class extends ShaderBase {
...
var vanta_halo_default = VANTA.register("HALO", Halo);
Halo.prototype.fragmentShader = `uniform vec2 iResolution;
uniform float iDpr;
uniform vec2 iMouse;
uniform float iTime;
...
`;
export {
  vanta_halo_default as default
};
//# sourceMappingURL=vanta_src_vanta__halo.js.map
